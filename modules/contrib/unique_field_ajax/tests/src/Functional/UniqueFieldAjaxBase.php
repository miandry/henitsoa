 ...
 */
abstract class UniqueFieldAjaxBase extends BrowserTestBase {
  ...
  protected function createField(
    ...
    $field_name = $customFieldName === "" ? $this->createRandomData() : $customFieldName;
